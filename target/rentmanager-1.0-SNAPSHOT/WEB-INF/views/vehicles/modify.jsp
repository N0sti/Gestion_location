                        ...
                        <form class="form-horizontal" method="post">
                            <div class="box-body">
                                <div class="form-group">
                                    ...
                                    <div class="col-sm-10">
                                        <input type="text" class="form-control" required id="manufacturer" name="manufacturer" placeholder="Marque" value="${vehicle.getConstructeur()}">
                                ...
                                <div class="form-group">
                                    ...
                                    <div class="col-sm-10">
                                        <input type="text" class="form-control" required id="modele" name="modele" placeholder="Modele" required value="${vehicle.getModele()}">
                                    </div>
                                </div>
                                <div class="form-group">
                                    ...
                                    <div class="col-sm-10">
                                        <input type="text" class="form-control" required id="seats" name="seats" placeholder="NB_place" required value="${vehicle.getNb_places()}">
                                    </div>
                                </div>
                                <!--
                                <div class="form-group">
                            ...
                            <div class="box-footer">
                                <button type="submit" class="btn btn-info pull-right">Modifer</button>
                            </div>
                            <!-- /.box-footer -->
                        </form>
                    </div>
